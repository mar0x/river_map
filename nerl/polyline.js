...
function update_distance() {
    ...
    myMap.balloon.open(
        myMap.getCenter(),
        {
          contentHeader: "План сплава",
          contentBody: b,
          draggable: true,    // Балон можно перемещать.
        }
    );
...
function init() {
    jQuery.get(xml_name, function(doc) {
        ...
        var start_at = find_nearest([56.8469101, 39.1735822]);
        ...
        var end_at = find_nearest([56.7672921, 39.529593]);
